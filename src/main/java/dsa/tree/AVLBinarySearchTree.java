...
public class AVLBinarySearchTree<Key extends Comparable<Key>, Value> extends BinaryTree<Value> {
    ...
    private BinaryNode rotateRight(BinaryNode x) {
        BinaryNode y = x.left;
        x.left = y.right;
        y.right = x;
        y.size = x.size;
    ...
    private BinaryNode balance(BinaryNode x) {
