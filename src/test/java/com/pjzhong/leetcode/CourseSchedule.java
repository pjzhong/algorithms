 ...
 * course 1 you should have finished course 0. So it is possible. Example 2:
 *
 ...
 * finished course 1. So it is impossible. Note:
 *
...
public class CourseSchedule {
  ...
  public boolean canFinish(int numCourses, int[][] prerequisites) {
    ...
    for (int[] pre : prerequisites) {
      ...
      if (list == null) {
        adjenct.put(pre[0], list = new ArrayList<>());
      }
      list.add(pre[1]);
    }
