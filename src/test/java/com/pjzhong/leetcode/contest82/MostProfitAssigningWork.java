...
/**
 * Most Profit Assigning Work User Accepted: 0 User Tried: 0 Total Accepted: 0 Total Submissions: 0
 * Difficulty: Medium We have jobs: difficulty[i] is the difficulty of the ith job, and profit[i] is
 ...
 * Example 1:
 *
 * Input: difficulty = [2,4,6,8,10], profit = [10,20,30,40,50], worker = [4,5,6,7] Output: 100
 * Explanation: Workers are assigned jobs of difficulty [4,4,6,6] and they get profit of
 * [20,20,30,30] seperately. Notes:
 *
 * 1 <= difficulty.length = profit.length <= 10000 1 <= worker.length <= 10000 difficulty[i],
 * profit[i], worker[i]  are in range [1, 10^5]
 */
