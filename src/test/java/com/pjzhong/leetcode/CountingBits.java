 ...
 * Follow up:
 * <p>
 * It is very easy to come up with a solution with run com.pjzhong.time O(n*sizeof(integer)). But can you do it in linear com.pjzhong.time O
 ...
 * language.
 *
 * @link https://com.pjzhong.leetcode.com/problems/counting-bits/
 */
