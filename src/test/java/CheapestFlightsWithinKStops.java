...
public class CheapestFlightsWithinKStops {
    ...
    public void test() {
        ...
        int[][][] edges = {
                ...
                {{0,1,100},{1,2,100},{0,2,500}},
                {{0, 1, 7},{0,2,8},{1,4,6},{1,5,4},{2,9,11},{2,7,12},{4,8,5},{5,8,2},{9,3,20},{7,3,24},{3,8,26}}
        };
        int[][] SrcDescStep = {
                {0,2,2},
                {13,4,13},
        ...
        for(int i = 0; i < veterx.length; i ++) {
            System.out.println(findCheapestPrice(veterx[i], edges[i], SrcDescStep[i][0], SrcDescStep[i][1], SrcDescStep[i][2]));
        }
    }
