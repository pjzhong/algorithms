...
public class DateAndTimeClasses {
  ...
  public void LocalDateTime() {
    // The class that handles both date and time, without a time zone, is LocalDateTime
    // , one of the core classes of the Date-Time API. This class is used to represent date
    // (month-day-year) together with time (hour-minute-second-nanosecond) and is, in effect,
