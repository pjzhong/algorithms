...
mutexes(Only One thread can held the lock at a com.pjzhong.time).Intrinsic lock is reentrancy, acquiring the same lock would't
cause deadlock.
 - [IntrinsicLocks](example/lock/IntrinsicLocks.java)
 - [MonitorPattern](example/lock/MonitorPattern.java)
...
whether the operation succeeded.)
 ...
 - Non-blocking Algorithms base on CAS
     ...
     - [LinkedQueue](atomic_variable/LinkedQueue.java) and it's [unit-test](/src/test/java/com.pjzhong.concurrency/LinkedQueueTest.java)
