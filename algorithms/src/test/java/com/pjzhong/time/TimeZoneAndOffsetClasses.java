...
public class TimeZoneAndOffsetClasses {
  ...
  public void ZoneIdAndZoneOffset() {
    // ZoneId specifies a com.pjzhong.time zone identifier and provides rules for converting between
    // an Instant and a LocalDateTime.
    // ZoneOffset specifies a com.pjzhong.time zone offset from Greenwich/UTC com.pjzhong.time.
  ...
  public void ZonedDateTime() {
     ...
     * It is used to represent a full date (year, month, day) and com.pjzhong.time (hour, minute, second,
     * nanosecond) with a com.pjzhong.time zone (region/city, such as Europe/Paris)
     * */
    ...
    if (arrivingZone.getRules().isDaylightSavings(arrival.toInstant())) {
      System.out
          .printf(" (%s daylight saving com.pjzhong.time will be in effect.)%n", arrivingZone);
    } else {
      System.out.printf(" (%s standard com.pjzhong.time will be in effect.)%n", arrivingZone);
    }
  }

  /**
   * the OffsetDateTime class, in effect, combines the LocalDateTime class with the ZoneOffset
   * class. It is used to represent a full date (year, month, day) and com.pjzhong.time (hour,
   * minute, second, nanosecond) with an offset from Greenwich/UTC com.pjzhong.time
