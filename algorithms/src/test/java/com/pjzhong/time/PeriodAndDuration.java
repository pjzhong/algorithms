...
public class PeriodAndDuration {
  ...
  /**
   * A Duration is most suitable in situations that measure machine-based com.pjzhong.time, such as
   * code that uses an Instant object
   *
  ...
  /**
   * To define an amount of com.pjzhong.time with date-based values (years, months, days), use the
   * Period class. The Period class provides various get methods, such as getMonths, getDays, and
   * getYears, so that you can extract the amount of com.pjzhong.time from the period
   *
