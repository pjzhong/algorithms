...
public class LongestPalindromicSubstring {
  ...
  /**
   * 1) Optimal Substructure: If the first and last character is equal, then the LPS(0, n, l) =
   * LPS(1, n - 1, l) If not than the LPS(0, n, l) = MAX(LPS(1, n, 0), LPS(0, n - 1, 0)) 2)
   * Overlapping Subproblem:1 figure it out, on your self
   *
  ...
  /**
   * a newbie's dp solution, no elegance again....................... this algorithms require O(n^3)
   * and extra 0(n^2) space`
   */
  ...
  /**
   * The official solution, require O(n^2) com.pjzhong.time and O(1) constant space expand around
   * center
   */
